...
class DiscussionRejetees extends StatefulWidget {
  @override
  _DiscussionRejeteesState createState() => _DiscussionRejeteesState();
}

class _DiscussionRejeteesState extends State<DiscussionRejetees> {
  Widget _content = CircularProgressIndicator();
  int nbr_discussion_rejetees;
  List<Discussion> discussions_rejetees = List();
  ...
  getMyDiscuss() {
    ...
    DiscussionController()
        .getDiscussWithOwnerAndStatus(context, "REJETEE")
        .then((value) {
      if (mounted) {
        setState(() {
          discussions_rejetees = value;
          filteredDiscussions = discussions_rejetees;
        });
      }
    })
  ...
  getAllDiscuss() {
    isLoading = true;
    DiscussionController().getAllDiscussRejected(context).then((value) {
      if (mounted) {
        setState(() {
          discussions_rejetees = value;
          filteredDiscussions = discussions_rejetees;
