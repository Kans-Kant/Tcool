...
class InterventionRejetees extends StatefulWidget {
  @override
  _InterventionRejeteesState createState() => _InterventionRejeteesState();
}

class _InterventionRejeteesState extends State<InterventionRejetees> {
  Widget progressIndicator = CircularProgressIndicator();
  List<Intervention> interventionAnnulees = List();
  ...
  getMyInterventions() {
    ...
    if (mounted) {
      ...
      InterventionController()
          .getInterventionsWithOwnerAndStatus(context, "ANNULEE")
          .then((value) {
        if (mounted) {
          setState(() {
            interventionAnnulees = value;
            filteredInterventions = interventionAnnulees;
          });
        }
      })
  ...
  getAllInterventions() {
    isLoading = true;
    InterventionController().getAllInterventionsAnnulees(context).then((value) {
      if (mounted) {
        setState(() {
          interventionAnnulees = value;
          filteredInterventions = interventionAnnulees;
